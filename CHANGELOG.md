...
- 0.3.3.7 – (2026/03/16) CDB symbol export feature (issue #17), MAX name bug fix (issue #13), plain/megarom auto mode parameter (-a), VSCode MSX-BASIC project initializer (--vscode), extensive code refactoring and memory allocation hardenings;
