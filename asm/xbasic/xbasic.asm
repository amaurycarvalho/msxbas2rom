...
cmd_runp_start:
	defw parse_table_end		;404b	49 41 	I A 
cmd_runp_end:
...
; BLOCK 'kernel' (start 0x4065 end 0x4096)
kernel_start:
	push hl			;4065	e5 	. 
	ld a,(de)			;4066	1a 	. 
	inc a			;4067	3c 	< 
...
; BLOCK 'parse_table' (start 0x4097 end 0x4149)
parse_table_start:
	defw 04e16h		;4097	16 4e 	. N 
	defw TOKEN_81_END		;4099	0a 4d 	. M 
	defw TOKEN_82_FOR		;409b	0e 48 	. H 
	defw TOKEN_83_NEXT		;409d	bf 48 	. H 
	defw TOKEN_84_DATA		;409f	f2 4d 	. M 
	defw TOKEN_85_INPUT		;40a1	6b 4a 	k J 
	defw TOKEN_86_DIM		;40a3	2c 45 	, E 
	defw TOKEN_87_READ		;40a5	19 45 	. E 
	defw TOKEN_88_LET		;40a7	5f 44 	_ D 
	defw TOKEN_89_GOTO		;40a9	96 46 	. F 
	defw TOKEN_8A_RUN		;40ab	7c 46 	| F 
	defw TOKEN_8B_IF		;40ad	dd 45 	. E 
	defw TOKEN_8C_RESTORE		;40af	2a 4a 	* J 
	defw TOKEN_8D_GOSUB		;40b1	99 46 	. F 
	defw TOKEN_8E_RETURN		;40b3	89 46 	. F 
	defw TOKEN_8F_REM		;40b5	ba 43 	. C 
	defw TOKEN_90_STOP		;40b7	13 4d 	. M 
	defw TOKEN_91_PRINT		;40b9	34 4b 	4 K 
	defw 04e16h		;40bb	16 4e 	. N 
	defw 04e16h		;40bd	16 4e 	. N 
	defw 04e16h		;40bf	16 4e 	. N 
	defw TOKEN_95_ON		;40c1	c0 46 	. F 
	defw TOKEN_96_WAIT		;40c3	a6 4c 	. L 
	defw TOKEN_97_DEF		;40c5	e3 4c 	. L 
	defw TOKEN_98_POKE		;40c7	9e 4b 	. K 
	defw 04e16h		;40c9	16 4e 	. N 
	defw 04e16h		;40cb	16 4e 	. N 
	defw 04e16h		;40cd	16 4e 	. N 
	defw TOKEN_9C_OUT		;40cf	1b 4c 	. L 
	defw TOKEN_9D_LPRINT		;40d1	1d 4b 	. K 
	defw 04e16h		;40d3	16 4e 	. N 
	defw TOKEN_9F_CLS		;40d5	54 69 	T i 
	defw 04e16h		;40d7	16 4e 	. N 
	defw 04e16h		;40d9	16 4e 	. N 
	defw 04e16h		;40db	16 4e 	. N 
	defw 04e16h		;40dd	16 4e 	. N 
	defw TOKEN_A4_SWAP		;40df	df 47 	. G 
	defw 04e16h		;40e1	16 4e 	. N 
	defw 04e16h		;40e3	16 4e 	. N 
	defw 04e16h		;40e5	16 4e 	. N 
	defw 04e16h		;40e7	16 4e 	. N 
	defw 04e16h		;40e9	16 4e 	. N 
	defw 04e16h		;40eb	16 4e 	. N 
	defw TOKEN_AB_DEFSTR		;40ed	9a 47 	. G 
	defw TOKEN_AC_DEFINT		;40ef	97 47 	. G 
	defw TOKEN_AD_DEFSNG		;40f1	9d 47 	. G 
	defw TOKEN_AE_DEFDBL		;40f3	a0 47 	. G 
	defw TOKEN_AF_LINE		;40f5	d3 66 	. f 
	defw 04e16h		;40f7	16 4e 	. N 
	defw 04e16h		;40f9	16 4e 	. N 
	defw 04e16h		;40fb	16 4e 	. N 
	defw TOKEN_B3_PUT		;40fd	7e 68 	~ h 
	defw 04e16h		;40ff	16 4e 	. N 
	defw 04e16h		;4101	16 4e 	. N 
	defw 04e16h		;4103	16 4e 	. N 
	defw 04e16h		;4105	16 4e 	. N 
	defw 04e16h		;4107	16 4e 	. N 
	defw 04e16h		;4109	16 4e 	. N 
	defw 04e16h		;410b	16 4e 	. N 
	defw 04e16h		;410d	16 4e 	. N 
	defw TOKEN_BC_CIRCLE		;410f	51 68 	Q h 
	defw TOKEN_BD_COLOR		;4111	a2 65 	. e 
	defw 04e16h		;4113	16 4e 	. N 
	defw TOKEN_BF_PAINT		;4115	be 6a 	. j 
	defw TOKEN_C0_BEEP		;4117	95 4b 	. K 
	defw 04e16h		;4119	16 4e 	. N 
	defw TOKEN_C2_PSET		;411b	78 67 	x g 
	defw TOKEN_C3_PRESET		;411d	79 67 	y g 
	defw TOKEN_C4_SOUND		;411f	a5 4d 	. M 
	defw TOKEN_C5_SCREEN		;4121	31 69 	1 i 
	defw TOKEN_C6_VPOKE		;4123	5a 69 	Z i 
	defw TOKEN_C7_SPRITE		;4125	22 4d 	" M 
	defw TOKEN_C8_VDP		;4127	7f 6a 	 j 
	defw 04e16h		;4129	16 4e 	. N 
	defw TOKEN_CA_CALL		;412b	36 4e 	6 N 
	defw TOKEN_CB_TIME		;412d	e6 4d 	. M 
	defw TOKEN_CC_KEY		;412f	34 4d 	4 M 
	defw 04e16h		;4131	16 4e 	. N 
	defw 04e16h		;4133	16 4e 	. N 
	defw 04e16h		;4135	16 4e 	. N 
	defw 04e16h		;4137	16 4e 	. N 
	defw 04e16h		;4139	16 4e 	. N 
	defw TOKEN_D2_SET		;413b	a1 69 	. i 
	defw 04e16h		;413d	16 4e 	. N 
	defw 04e16h		;413f	16 4e 	. N 
	defw 04e16h		;4141	16 4e 	. N 
	defw TOKEN_D6_COPY		;4143	1b 6b 	. k 
	defw 04e16h		;4145	16 4e 	. N 
	defw TOKEN_D8_LOCATE		;4147	c7 4d 	. M 
parse_table_end:
CMD_CALL_RUN:

; BLOCK 'parse_code' (start 0x4149 end 0x8000)
parse_code_start:
...
l4174h:
	...
	inc ix		;4181	dd 23 	. # 
	inc ix		;4183	dd 23 	. # 
	call GET_NEXT_TOKEN		;4185	cd 30 60 	. 0 ` 
	cp 0cah		;4188	fe ca 	. . 
...
EXEC_COMPILED_CODE_INIT:
	call TOKEN_81_END		;422b	cd 0a 4d 	. . M 
...
EXEC_JUMP_TO_COMPILED_CODE:
	jp (hl)			;4257	e9 	. 
sub_4258h:
	call GET_NEXT_TOKEN		;4258	cd 30 60 	. 0 ` 
	and a			;425b	a7 	. 
	ret z			;425c	c8 	. 
	cp 03ah		;425d	fe 3a 	. : 
	scf			;425f	37 	7 
...
l4270h:
	...
	call TOKEN_CA_CALL		;4277	cd 36 4e 	. 6 N 
...
l4285h:
	...
	call ASSERT_NEXT_TOKEN_BE		;42a3	cd 48 60 	. H ` 
	ld a,052h		;42a6	3e 52 	> R 
	call ASSERT_NEXT_TOKEN_BE		;42a8	cd 48 60 	. H ` 
	ld a,0ffh		;42ab	3e ff 	> . 
	call ASSERT_NEXT_TOKEN_BE		;42ad	cd 48 60 	. H ` 
	ld a,094h		;42b0	3e 94 	> . 
	call ASSERT_NEXT_TOKEN_BE		;42b2	cd 48 60 	. H ` 
...
l42b8h:
	...
	ld bc,parse_table_start		;42c1	01 97 40 	. . @ 
	add hl,bc			;42c4	09 	. 
	ld a,(hl)			;42c5	7e 	~ 
	inc hl			;42c6	23 	# 
	ld h,(hl)			;42c7	66 	f 
...
l42cch:
	call GET_NEXT_TOKEN		;42cc	cd 30 60 	. 0 ` 
	and a			;42cf	a7 	. 
	ret z			;42d0	c8 	. 
	cp 03ah		;42d1	fe 3a 	. : 
	scf			;42d3	37 	7 
