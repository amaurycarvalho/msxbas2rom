...
/***
 * @class Compiler
 * @brief Compiler class for semantic analysis, specialized as a Z80 code builder
 * for MSX system
 */
class Compiler {
  /***
   ...
   * See [nop](http://z80-heaven.wikidot.com/instructions-set:nop) for more information.
