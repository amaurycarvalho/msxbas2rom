...
- Bank 3 (0x8000-0x9FFF): switch address 0x9000
- Bank 4 (0xA000-0xBFFF): switch address 0xB000

The kernel segment-switch addresses for upper banks (0x9000 for Bank 3, 0xB000 for Bank 4) SHALL be patched via the same binary patch used for KonamiSCC.
...
- **THEN** the compiled kernel binary SHALL contain writes to 0x9000 (Bank 3) and 0xB000 (Bank 4) instead of 0x7000 and 0x7800
- **AND** exactly 11 address locations SHALL be patched
