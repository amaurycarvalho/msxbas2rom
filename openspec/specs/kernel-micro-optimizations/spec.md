...
Defines micro-optimizations applied to the Z80 kernel assembly to reduce code size, improve performance, and eliminate dead code, while preserving behavioral compatibility across all routines.
...
- **THEN** E contains the value shifted left by 4 bits (low nibble to high nibble)
...
### Requirement: cmd_wrtfnt uses ld de,7 / add hl,de instead of 7x inc hl
