...
- [ ] Propose a plan to refactor step by step CompilerCmdStatementStrategy creating specialized methods to cmd_cmd() - or a better solution - and ask for approval;
