...
- [ ] At src/application/lexer, rename lex.cpp to lexer.cpp and lex.h to lexer.h. Next, at src/application/parser, rename parse.cpp to parser.cpp and parse.h to parser.h. Finally, adjust the related Makefile and unit testings according the changes;
