...
int SgnCompilerFunctionStrategy::execute(shared_ptr<CompilerContext> context,
  ...
  if (result[0] == Lexeme::subtype_numeric) {
    ...
    optimizer.addKernelCall(DISP_XBASIC_SGN_INT);
    ...
    optimizer.addKernelCall(DISP_XBASIC_SGN_FLOAT);
