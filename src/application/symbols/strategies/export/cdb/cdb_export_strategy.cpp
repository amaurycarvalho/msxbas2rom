...
bool CdbExportStrategy::save(shared_ptr<SymbolExportContext> context,
  ...
  context->exportFilename = opts->baseFilename + ".cdb";

  file = fopen(context->exportFilename.c_str(), "w");
