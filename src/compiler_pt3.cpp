        ...
        for(i = 0; i < t; i++) {
            ...
            switch(i) {
                ...
                case 2: {
                        // ld a, l
                        addByte(0x7D);
                        // ld (0xF3DB), a   ; CLIKSW - 0=keyboard click off, 1=keyboard click on
                        addCmd(0x32, 0xF3DB);
                    }
                    break;
...
void CompilerPT3::cmd_circle() {
    ...
    unsigned int i, t = current_action->actions.size();
    int result_subtype;
    bool has_x_coord=false, has_y_coord=false, has_color=false, has_radius=false;
...
void CompilerPT3::cmd_put_sprite() {
    ...
    if(t) {
        ...
        // call 0x71BD   ; xbasic PUT SPRITE (in: ix=x, iy=y, d=color, a=sprite number, h=pattern number, b=parameters flag (b11100000)
