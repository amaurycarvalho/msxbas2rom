...
const set<string> keywords = {
    "?",         "ABS",       "ADJUST",       "AND",
    "APPEND",    "ASC",       "ATN",          "BASE",
    "BEEP",      "BIN$",      "BLOAD",        "BSAVE",
    "CALL",      "CDBL",      "CHR$",         "CINT",
    "CIRCLE",    "CLEAR",     "CLRSCR",       "CLRKEY",
    "CLS",       "CLOAD",     "CLOSE",        "CMD",
    "COLLISION", "COLOR",     "COPY",         "COS",
    "CSAVE",     "CSNG",      "CSRLIN",       "DATA",
    "DATE",      "DEF",       "DEFDBL",       "DEFINT",
    "DEFSNG",    "DEFSTR",    "DIM",          "DISSCR",
    "DRAW",      "DSKF",      "ELSE",         "ENASCR",
    "END",       "EOF",       "EQV",          "ERASE",
    "ERROR",     "EXP",       "FILES",        "FILE",
    "FIX",       "FLIP",      "FN",           "FONT",
    "FOR",       "FROM",      "FRE",          "GET",
    "GOSUB",     "GOTO",      "HEAP",         "HEX$",
    "IDATA",     "IF",        "IMP",          "INCLUDE",
    "INKEY",     "INKEY$",    "INP",          "INPUT",
    "INPUT$",    "INSTR",     "INT",          "INTERVAL",
    "IPEEK",     "IPOKE",     "IREAD",        "IRESTORE",
    "KANJI",     "KEY",       "KEYCLKOFF",    "LEFT$",
    "LEN",       "LET",       "LINE",         "LLIST",
    "LOAD",      "LOCATE",    "LOG",          "LPOS",
    "LPRINT",    "MAKER",     "MAXFILES",     "MERGE",
    "MID$",      "MOD",       "MOTOR",        "MSX",
    "MUTE",      "NEW",       "NEXT",         "NOT",
    "NTSC",      "OCT$",      "OFF",          "ON",
    "OPEN",      "OR",        "OUT",          "OUTPUT",
    "PAD",       "PAGE",      "PAINT",        "PASTE",
    "PATTERN",   "PAUSE",     "PDL",          "PEEK",
    "PLAY",      "PLYLOAD",   "PLYLOOP",      "PLYMUTE",
    "PLYPLAY",   "PLYREPLAY", "PLYSOUND",     "PLYSTATUS",
    "PLYSONG",   "POINT",     "POKE",         "POS",
    "PRESET",    "PRINT",     "PROMPT",       "PSG",
    "PSET",      "PT3LOAD",   "PT3LOOP",      "PT3MUTE",
    "PT3PLAY",   "PT3REPLAY", "PUT",          "RANDOMIZE",
    "RAMTORAM",  "RAMTOVRAM", "READ",         "REDIM",
    "REM",       "RESOURCE",  "RESOURCESIZE", "RESTORE",
    "RESUME",    "RETURN",    "RIGHT$",       "RND",
    "ROTATE",    "RSCTORAM",  "RUN",          "RUNASM",
    "RUNBAS",    "SAVE",      "SCREEN",       "SCROLL",
    "SEED",      "SET",       "SETFNT",       "SGN",
    "SHL",       "SHR",       "SIN",          "SOUND",
    "SPACE$",    "SPC",       "SPRITE",       "SPRITE$",
    "SQR",       "STEP",      "STICK",        "STOP",
    "STR$",      "STRING$",   "STRIG",        "SWAP",
    "TAB",       "TAN",       "TAND",         "TEXT",
    "THEN",      "TILE",      "TILES",        "TIME",
    "TITLE",     "TO",        "TOR",          "TPRESET",
    "TPSET",     "TURBO",     "TXOR",         "UPDFNTCLR",
    "USR",       "USING",     "USING$",       "VAL",
    "VARPTR",    "VDP",       "VIDEO",        "VPEEK",
    "VPOKE",     "VRAMTORAM", "WAIT",         "WIDTH",
    "WRTCHR",    "WRTCLR",    "WRTFNT",       "WRTSCR",
    "WRTSPRATR", "WRTSPRCLR", "WRTSPRPAT",    "WRTVRAM",
    "XOR",       "_"};
...
const set<string> functions = {
    ...
    "FIX",    "FRE",    "HEAP",  "HEX$",      "INKEY",        "INKEY$",
    "INP",    "INPUT$", "INSTR", "INT",       "IPEEK",        "LEFT$",
    "LEN",    "LOG",    "LPOS",  "MAKER",     "MID$",         "MSX",
    "NTSC",   "OCT$",   "PAD",   "PDL",       "PEEK",         "PLYSTATUS",
    "POINT",  "POS",    "PSG",   "RESOURCE",  "RESOURCESIZE", "RIGHT$",
    "RND",    "SGN",    "SIN",   "SPACE$",    "SPC",          "SPRITE$",
    "SNG",    "SQR",    "STICK", "STR$",      "STRING$",      "STRIG",
    "TAB",    "TAN",    "TILE",  "TIME",      "TURBO",        "USR",
    "USR0",   "USING$", "VAL",   "VARPTR",    "VDP",          "VPEEK"};
}  // namespace
