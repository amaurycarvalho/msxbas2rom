...
XBASIC_ADD_FLOATS: equ 0x76D7
XBASIC_MULTIPLY_FLOATS: equ 0x7748
XBASIC_DIVIDE_FLOATS: equ 0x782C
XBASIC_SIN: equ 0x79EA
XBASIC_COS: equ 0x79E2
XBASIC_TAN: equ 0x7A41
XBASIC_ATN: equ 0x7A63
XBASIC_EXP: equ 0x7AA8
XBASIC_LOG: equ 0x7B01
XBASIC_SQR: equ 0x7B60
XBASIC_RND: equ 0x768E
XBASIC_INT: equ 0x7999
XBASIC_FIX: equ 0x798C
XBASIC_SGN_INT: equ 0x6BD5
XBASIC_SGN_FLOAT: equ 0x6BE1
XBASIC_ABS_INT: equ 0x6BED
XBASIC_LEFT: equ 0x7E42
XBASIC_RIGHT: equ 0x7E49
XBASIC_MID: equ 0x7E5A
XBASIC_MID_ASSIGN: equ 0x7E81
XBASIC_INSTR: equ 0x7F15
XBASIC_VAL: equ 0x7EB0
XBASIC_STRING: equ 0x7EF2
XBASIC_OCT_HEX_BIN: equ 0x7EC9
XBASIC_INKEY: equ 0x7F01
XBASIC_COPY_STRING: equ 0x7F44
XBASIC_COPY_STRING_TO_NULBUF: equ 0x7F40
XBASIC_CONCAT_STRINGS: equ 0x7F99
XBASIC_COMPARE_FLOATS_EQ: equ 0x792A
XBASIC_COMPARE_FLOATS_NE: equ 0x7933
XBASIC_COMPARE_FLOATS_GT: equ 0x793C
XBASIC_COMPARE_FLOATS_GE: equ 0x7946
XBASIC_COMPARE_FLOATS_LT: equ 0x794F
XBASIC_COMPARE_FLOATS_LE: equ 0x7958
XBASIC_COMPARE_STRING_WITH_NULBUF_EQ: equ 0x7F55
XBASIC_COMPARE_STRING_WITH_NULBUF_NE: equ 0x7F67
XBASIC_COMPARE_STRING_WITH_NULBUF_GT: equ 0x7F4B
XBASIC_COMPARE_STRING_WITH_NULBUF_GE: equ 0x7F5B
XBASIC_COMPARE_STRING_WITH_NULBUF_LT: equ 0x7F61
XBASIC_COMPARE_STRING_WITH_NULBUF_LE: equ 0x7F6D
XBASIC_CAST_FLOAT_TO_INTEGER: equ 0x7901
XBASIC_CAST_FLOAT_TO_STRING: equ 0x7C2B
XBASIC_CAST_STRING_TO_FLOAT: equ 0x7EB0
XBASIC_POWER_FLOAT_TO_INTEGER: equ 0x7878
XBASIC_POWER_FLOAT_TO_FLOAT: equ 0x78BF
XBASIC_POINT: equ 0x6FA9
XBASIC_LINE: equ 0x6DA9
XBASIC_BOX: equ 0x6D4B
XBASIC_BOXF: equ 0x6E29
XBASIC_PSET: equ 0x6F73
XBASIC_PAINT: equ 0x74BC
XBASIC_CIRCLE: equ 0x74DC
XBASIC_CIRCLE2: equ 0x74EE
XBASIC_COLOR_RGB: equ 0x710E
XBASIC_COLOR_SPRITE: equ 0x7189
XBASIC_COLOR_SPRSTR: equ 0x7194
XBASIC_SCREEN_SPRITE: equ 0x70BE
XBASIC_SPRITE_ASSIGN: equ 0x7145
XBASIC_SET_PAGE: equ 0x70CC
XBASIC_SET_SCROLL: equ 0x7004
XBASIC_VDP: equ 0x7339
XBASIC_VPEEK: equ 0x70A3
XBASIC_VPOKE: equ 0x70B7
XBASIC_TRAP_ON: equ 0x6C8B
XBASIC_TRAP_OFF: equ 0x6C9E
XBASIC_TRAP_STOP: equ 0x6CA7
XBASIC_TRAP_CHECK: equ 0x6C27
XBASIC_SWAP_INTEGER: equ 0x6BF7
XBASIC_SWAP_STRING: equ 0x6BFB
XBASIC_SWAP_FLOAT: equ 0x6BFF
XBASIC_PRINT_TAB: equ 0x74F3
XBASIC_PRINT_INT: equ 0x7508
XBASIC_PRINT_FLOAT: equ 0x750D
XBASIC_PRINT_CRLF: equ 0x74F7
WriteParamBCD: equ 0x6C0B
