    ...
    const StatementCase cases[] = {
        ...
        {"SET_TILE_ROTATE_BANK",
         ...
         {"SET_TILE_COLOR_INVALID",
          "10 SET TILE COLOR 5\n20 END\n", false},
         {"SET_SPRITE_HITBOX_ON",
          "10 SET SPRITE HITBOX ON\n20 END\n", true},
         {"SET_SPRITE_HITBOX_OFF",
          "10 SET SPRITE HITBOX OFF\n20 END\n", true},
         {"SET_SPRITE_HITBOX_AUTO",
          "10 SET SPRITE HITBOX AUTO\n20 END\n", true},
         {"SET_SPRITE_HITBOX_ONE",
          "10 SET SPRITE HITBOX 3\n20 END\n", true},
         {"SET_SPRITE_HITBOX_ONE_ON",
          "10 SET SPRITE HITBOX 3 ON\n20 END\n", true},
         {"SET_SPRITE_HITBOX_ONE_OFF",
          "10 SET SPRITE HITBOX 3 OFF\n20 END\n", true},
         {"SET_SPRITE_HITBOX_ONE_AUTO",
          "10 SET SPRITE HITBOX 3 AUTO\n20 END\n", true},
         {"SET_SPRITE_HITBOX_MARGINS",
          "10 SET SPRITE HITBOX 3, 2, 3, 2, 4\n20 END\n", true},
         {"SET_SPRITE_HITBOX_MARGINS_OMITTED",
          "10 SET SPRITE HITBOX 3, 2\n20 END\n", true},
     };
