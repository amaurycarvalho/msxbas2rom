...
BIOS_DATLIN:	equ 0xf6a3
SUBFLG:	equ 0xf6a5
SAVSTK:	equ 0xf6b1
BASIC_STREND:	equ 0xf6c6
BASIC_DATPTR:	equ 0xf6c8
BASIC_DEFTBL:	equ 0xf6ca
BASIC_SWPTMP:	equ 0xf7bc
SWPTMP1:	equ 0xf7bd
BASIC_STRBUF:	equ 0xf7c5
BASIC_DAC:	equ 0xf7f6
MODE:	equ 0xfafc
BASIC_ONGSBF:	equ 0xfbd8
BASIC_TRPTBL:	equ 0xfc4c
BASIC_TRPTBL_STOP:	equ 0xfc6a
BASIC_TRPTBL_SPRITE:	equ 0xfc6d
BASIC_TRPTBL_STRIG:	equ 0xfc70
BASIC_TRPTBL_INTERVAL:	equ 0xfc7f
...
; BLOCK 'header1' (start 0x4000 end 0x4010)
header1_start:
	defw 04241h		;4000	41 42 	A B 
	defw 00000h		;4002	00 00 	. . 
l4004h:
	defw STATEMENT		;4004	32 40 	2 @ 
	defw 00000h		;4006	00 00 	. . 
	defw 00000h		;4008	00 00 	. . 
	defw 00000h		;400a	00 00 	. . 
	defw 00000h		;400c	00 00 	. . 
	defw 00000h		;400e	00 00 	. . 
header1_end:

; BLOCK 'header2' (start 0x4010 end 0x4031)
header2_start:
	defb 042h		;4010	42 	B 
	defb 041h		;4011	41 	A 
	defb 053h		;4012	53 	S 
...
; BLOCK 'init' (start 0x4032 end 0x4047)
init_start:
	ei			;4032	fb 	. 
	ld de,init_end		;4033	11 47 40 	. G @ 
	push hl			;4036	e5 	. 
	ld hl,PROCNM		;4037	21 89 fd 	! . . 
	call kernel_start		;403a	cd 65 40 	. e @ 
	pop hl			;403d	e1 	. 
	ret c			;403e	d8 	. 
	call sub_4045h		;403f	cd 45 40 	. E @ 
	ei			;4042	fb 	. 
	and a			;4043	a7 	. 
	ret			;4044	c9 	. 
sub_4045h:
...
; BLOCK 'cmd_run' (start 0x4047 end 0x404b)
cmd_run_start:
	defb 052h		;4047	52 	R 
	defb 055h		;4048	55 	U 
	defb 04eh		;4049	4e 	N 
...
; BLOCK 'cmd_runp' (start 0x404b end 0x404d)
cmd_runp_start:
	defw CMD_CALL_RUN		;404b	49 41 	I A 
cmd_runp_end:

; BLOCK 'cmd_ton' (start 0x404d end 0x4056)
cmd_ton_start:
	defb 054h		;404d	54 	T 
	defb 055h		;404e	55 	U 
	defb 052h		;404f	52 	R 
...
; BLOCK 'cmd_tonp' (start 0x4056 end 0x4058)
cmd_tonp_start:
	defw CMD_CALL_TURBO_ON		;4056	88 4e 	. N 
cmd_tonp_end:

; BLOCK 'cmd_toff' (start 0x4058 end 0x4062)
cmd_toff_start:
	defb 054h		;4058	54 	T 
	defb 055h		;4059	55 	U 
	defb 052h		;405a	52 	R 
...
; BLOCK 'cmd_toffp' (start 0x4062 end 0x4064)
cmd_toffp_start:
	defw CMD_CALL_TURBO_OFF		;4062	ff 4e 	. N 
cmd_toffp_end:
	rst 38h			;4064	ff 	. 

; BLOCK 'kernel' (start 0x4065 end 0x8000)
kernel_start:
	push hl			;4065	e5 	. 
	ld a,(de)			;4066	1a 	. 
	inc a			;4067	3c 	< 
	jr z,l4075h		;4068	28 0b 	( . 
	call sub_4078h		;406a	cd 78 40 	. x @ 
	pop hl			;406d	e1 	. 
	jr nz,kernel_start		;406e	20 f5 	  . 
	ex de,hl			;4070	eb 	. 
	ld e,(hl)			;4071	5e 	^ 
	inc hl			;4072	23 	# 
	ld d,(hl)			;4073	56 	V 
...
l407ah:
	...
	inc de			;407c	13 	. 
	inc hl			;407d	23 	# 
	jr z,sub_4078h		;407e	28 f8 	( . 
	inc a			;4080	3c 	< 
	jr nz,l408dh		;4081	20 0a 	  . 
	dec hl			;4083	2b 	+ 
l4084h:
	ld a,(hl)			;4084	7e 	~ 
	cp 020h		;4085	fe 20 	.   
	inc hl			;4087	23 	# 
	jr z,l4084h		;4088	28 fa 	( . 
	dec hl			;408a	2b 	+ 
	jr l407ah		;408b	18 ed 	. . 
l408dh:
	dec de			;408d	1b 	. 
l408eh:
	ld a,(de)			;408e	1a 	. 
	and a			;408f	a7 	. 
	inc de			;4090	13 	. 
	jr nz,l408eh		;4091	20 fb 	  . 
	inc de			;4093	13 	. 
	inc de			;4094	13 	. 
	inc a			;4095	3c 	< 
	ret			;4096	c9 	. 
l4097h:
	ld d,04eh		;4097	16 4e 	. N 
	ld a,(bc)			;4099	0a 	. 
	ld c,l			;409a	4d 	M 
	ld c,048h		;409b	0e 48 	. H 
	cp a			;409d	bf 	. 
	ld c,b			;409e	48 	H 
	jp p,06b4dh		;409f	f2 4d 6b 	. M k 
	ld c,d			;40a2	4a 	J 
	inc l			;40a3	2c 	, 
	ld b,l			;40a4	45 	E 
	add hl,de			;40a5	19 	. 
	...
	ld a,h			;40ab	7c 	| 
	ld b,(hl)			;40ac	46 	F 
	ld b,ixl		;40ad	dd 45 	. E 
	ld hl,(0994ah)		;40af	2a 4a 99 	* J . 
	ld b,(hl)			;40b2	46 	F 
	adc a,c			;40b3	89 	. 
	ld b,(hl)			;40b4	46 	F 
	cp d			;40b5	ba 	. 
	...
	inc (hl)			;40b9	34 	4 
	ld c,e			;40ba	4b 	K 
	ld d,04eh		;40bb	16 4e 	. N 
	ld d,04eh		;40bd	16 4e 	. N 
	ld d,04eh		;40bf	16 4e 	. N 
	ret nz			;40c1	c0 	. 
	ld b,(hl)			;40c2	46 	F 
	and (hl)			;40c3	a6 	. 
	ld c,h			;40c4	4c 	L 
	...
	sbc a,(hl)			;40c7	9e 	. 
	ld c,e			;40c8	4b 	K 
	ld d,04eh		;40c9	16 4e 	. N 
	ld d,04eh		;40cb	16 4e 	. N 
	ld d,04eh		;40cd	16 4e 	. N 
	dec de			;40cf	1b 	. 
	ld c,h			;40d0	4c 	L 
	dec e			;40d1	1d 	. 
	ld c,e			;40d2	4b 	K 
	ld d,04eh		;40d3	16 4e 	. N 
	ld d,h			;40d5	54 	T 
	ld l,c			;40d6	69 	i 
	ld d,04eh		;40d7	16 4e 	. N 
	ld d,04eh		;40d9	16 4e 	. N 
	ld d,04eh		;40db	16 4e 	. N 
	ld d,04eh		;40dd	16 4e 	. N 
	rst 18h			;40df	df 	. 
	ld b,a			;40e0	47 	G 
	ld d,04eh		;40e1	16 4e 	. N 
	ld d,04eh		;40e3	16 4e 	. N 
	ld d,04eh		;40e5	16 4e 	. N 
	ld d,04eh		;40e7	16 4e 	. N 
	ld d,04eh		;40e9	16 4e 	. N 
	ld d,04eh		;40eb	16 4e 	. N 
	sbc a,d			;40ed	9a 	. 
	ld b,a			;40ee	47 	G 
	sub a			;40ef	97 	. 
	ld b,a			;40f0	47 	G 
	...
	and b			;40f3	a0 	. 
	ld b,a			;40f4	47 	G 
	out (066h),a		;40f5	d3 66 	. f 
	ld d,04eh		;40f7	16 4e 	. N 
	ld d,04eh		;40f9	16 4e 	. N 
	ld d,04eh		;40fb	16 4e 	. N 
	ld a,(hl)			;40fd	7e 	~ 
	ld l,b			;40fe	68 	h 
	ld d,04eh		;40ff	16 4e 	. N 
	ld d,04eh		;4101	16 4e 	. N 
	ld d,04eh		;4103	16 4e 	. N 
	ld d,04eh		;4105	16 4e 	. N 
	ld d,04eh		;4107	16 4e 	. N 
	ld d,04eh		;4109	16 4e 	. N 
	ld d,04eh		;410b	16 4e 	. N 
	ld d,04eh		;410d	16 4e 	. N 
	ld d,c			;410f	51 	Q 
	ld l,b			;4110	68 	h 
	and d			;4111	a2 	. 
	ld h,l			;4112	65 	e 
	ld d,04eh		;4113	16 4e 	. N 
	cp (hl)			;4115	be 	. 
	ld l,d			;4116	6a 	j 
	sub l			;4117	95 	. 
	ld c,e			;4118	4b 	K 
	ld d,04eh		;4119	16 4e 	. N 
	ld a,b			;411b	78 	x 
	ld h,a			;411c	67 	g 
	ld a,c			;411d	79 	y 
	ld h,a			;411e	67 	g 
	and l			;411f	a5 	. 
	ld c,l			;4120	4d 	M 
	ld sp,05a69h		;4121	31 69 5a 	1 i Z 
	ld l,c			;4124	69 	i 
	ld (l7f4dh),hl		;4125	22 4d 7f 	" M  
	ld l,d			;4128	6a 	j 
	ld d,04eh		;4129	16 4e 	. N 
	ld (hl),04eh		;412b	36 4e 	6 N 
	and 04dh		;412d	e6 4d 	. M 
	inc (hl)			;412f	34 	4 
	ld c,l			;4130	4d 	M 
	ld d,04eh		;4131	16 4e 	. N 
	ld d,04eh		;4133	16 4e 	. N 
	ld d,04eh		;4135	16 4e 	. N 
	ld d,04eh		;4137	16 4e 	. N 
	ld d,04eh		;4139	16 4e 	. N 
	and c			;413b	a1 	. 
	ld l,c			;413c	69 	i 
	ld d,04eh		;413d	16 4e 	. N 
	ld d,04eh		;413f	16 4e 	. N 
	ld d,04eh		;4141	16 4e 	. N 
	dec de			;4143	1b 	. 
	ld l,e			;4144	6b 	k 
	ld d,04eh		;4145	16 4e 	. N 
	rst 0			;4147	c7 	. 
	ld c,l			;4148	4d 	M 
CMD_CALL_RUN:
	ld (0f6afh),hl		;4149	22 af f6 	" . . 
	ld de,BASIC_DEFTBL		;414c	11 ca f6 	. . . 
	ld b,01ah		;414f	06 1a 	. . 
	ld a,008h		;4151	3e 08 	> . 
l4153h:
	ld (de),a			;4153	12 	. 
	inc de			;4154	13 	. 
	djnz l4153h		;4155	10 fc 	. . 
	ld hl,(BASIC_TXTTAB)		;4157	2a 76 f6 	* v . 
	dec hl			;415a	2b 	+ 
	ld (BASIC_DATPTR),hl		;415b	22 c8 f6 	" . . 
	inc hl			;415e	23 	# 
	xor a			;415f	af 	. 
CMD_CALL_RUN.PARSE:
	ld (0f565h),hl		;4160	22 65 f5 	" e . 
	ld (0f563h),a		;4163	32 63 f5 	2 c . 
	ld (SAVSTK),sp		;4166	ed 73 b1 f6 	. s . . 
	and a			;416a	a7 	. 
	jr z,l4171h		;416b	28 04 	( . 
	ld b,a			;416d	47 	G 
	xor a			;416e	af 	. 
	cpir		;416f	ed b1 	. . 
l4171h:
	ld bc,00000h		;4171	01 00 00 	. . . 
l4174h:
	inc bc			;4174	03 	. 
	ld a,(hl)			;4175	7e 	~ 
	inc hl			;4176	23 	# 
	...
	ld l,a			;417b	6f 	o 
	or h			;417c	b4 	. 
	jr z,l4191h		;417d	28 12 	( . 
	inc ix		;417f	dd 23 	. # 
	inc ix		;4181	dd 23 	. # 
	inc ix		;4183	dd 23 	. # 
	call sub_6030h		;4185	cd 30 60 	. 0 ` 
	cp 0cah		;4188	fe ca 	. . 
	jr z,l4190h		;418a	28 04 	( . 
	cp 05fh		;418c	fe 5f 	. _ 
	jr nz,l4174h		;418e	20 e4 	  . 
l4190h:
	inc bc			;4190	03 	. 
l4191h:
	ld l,c			;4191	69 	i 
	...
	add hl,bc			;4194	09 	. 
	add hl,hl			;4195	29 	) 
	ld (0f571h),hl		;4196	22 71 f5 	" q . 
	ex de,hl			;4199	eb 	. 
	ld hl,00000h		;419a	21 00 00 	! . . 
	add hl,sp			;419d	39 	9 
	sbc hl,de		;419e	ed 52 	. R 
	ld (VAR_ARGT),hl		;41a0	22 6f f5 	" o . 
	ld sp,hl			;41a3	f9 	. 
	ld (hl),0ffh		;41a4	36 ff 	6 . 
	inc hl			;41a6	23 	# 
	ld (hl),0ffh		;41a7	36 ff 	6 . 
	dec hl			;41a9	2b 	+ 
	dec h			;41aa	25 	% 
	dec h			;41ab	25 	% 
	dec hl			;41ac	2b 	+ 
	...
	dec hl			;41ae	2b 	+ 
	dec hl			;41af	2b 	+ 
	ld (hl),000h		;41b0	36 00 	6 . 
	ld (0f573h),hl		;41b2	22 73 f5 	" s . 
	ld (0f575h),hl		;41b5	22 75 f5 	" u . 
	xor a			;41b8	af 	. 
	ld (VAR_FNPTR),a		;41b9	32 62 f5 	2 b . 
	ld (VAR_DUMMY),a		;41bc	32 64 f5 	2 d . 
	ld (VAR_NX),a		;41bf	32 6a f5 	2 j . 
	ld (0f56bh),a		;41c2	32 6b f5 	2 k . 
	ld (VAR_NY),a		;41c5	32 6c f5 	2 l . 
	ld hl,(BASIC_STREND)		;41c8	2a c6 f6 	* . . 
	ld (BASIC_BUF),hl		;41cb	22 5e f5 	" ^ . 
	ld (0f560h),hl		;41ce	22 60 f5 	" ` . 
	ld ix,(0f565h)		;41d1	dd 2a 65 f5 	. * e . 
	ld a,(0f563h)		;41d5	3a 63 f5 	: c . 
	and a			;41d8	a7 	. 
	jr z,l41f1h		;41d9	28 16 	( . 
	ld a,(ix+000h)		;41db	dd 7e 00 	. ~ . 
	cp 03ah		;41de	fe 3a 	. : 
	jr z,l420fh		;41e0	28 2d 	( - 
	inc ix		;41e2	dd 23 	. # 
	and a			;41e4	a7 	. 
	jr z,l41f1h		;41e5	28 0a 	( . 
	cp 028h		;41e7	fe 28 	. ( 
	jp nz,04e16h		;41e9	c2 16 4e 	. . N 
	call PARSE_LINE		;41ec	cd 97 4e 	. . N 
	jr l4214h		;41ef	18 23 	. # 
l41f1h:
	ld a,(ix+000h)		;41f1	dd 7e 00 	. ~ . 
	or (ix+001h)		;41f4	dd b6 01 	. . . 
	jr z,l421ah		;41f7	28 21 	( ! 
	ld (0f56dh),ix		;41f9	dd 22 6d f5 	. " m . 
	ld l,(ix+002h)		;41fd	dd 6e 02 	. n . 
	ld h,(ix+003h)		;4200	dd 66 03 	. f . 
	ld (BASIC_CURLIN),hl		;4203	22 1c f4 	" . . 
	call sub_42d9h		;4206	cd d9 42 	. . B 
	inc ix		;4209	dd 23 	. # 
	inc ix		;420b	dd 23 	. # 
	inc ix		;420d	dd 23 	. # 
l420fh:
	inc ix		;420f	dd 23 	. # 
	call sub_4258h		;4211	cd 58 42 	. X B 
l4214h:
	jr c,l420fh		;4214	38 f9 	8 . 
	inc ix		;4216	dd 23 	. # 
	jr l41f1h		;4218	18 d7 	. . 
l421ah:
	ld a,(0f563h)		;421a	3a 63 f5 	: c . 
	and a			;421d	a7 	. 
	jr z,EXEC_COMPILED_CODE_INIT		;421e	28 0b 	( . 
	ld hl,(0f56dh)		;4220	2a 6d f5 	* m . 
	ld a,(hl)			;4223	7e 	~ 
	inc hl			;4224	23 	# 
	ld h,(hl)			;4225	66 	f 
	ld l,a			;4226	6f 	o 
	dec hl			;4227	2b 	+ 
	ld (0f6afh),hl		;4228	22 af f6 	" . . 
EXEC_COMPILED_CODE_INIT:
	call sub_4d0ah		;422b	cd 0a 4d 	. . M 
	call sub_4387h		;422e	cd 87 43 	. . C 
	call sub_648ah		;4231	cd 8a 64 	. . d 
	ld hl,(0f571h)		;4234	2a 71 f5 	* q . 
	add hl,sp			;4237	39 	9 
	ld sp,hl			;4238	f9 	. 
	ld hl,0fffeh		;4239	21 fe ff 	! . . 
	ld (BASIC_CURLIN),hl		;423c	22 1c f4 	" . . 
	ld hl,03579h		;423f	21 79 35 	! y 5 
	ld (BASIC_SWPTMP),hl		;4242	22 bc f7 	" . . 
	ld hl,l7531h		;4245	21 31 75 	! 1 u 
	ld (0f7beh),hl		;4248	22 be f7 	" . . 
	ld hl,MODE		;424b	21 fc fa 	! . . 
	res 4,(hl)		;424e	cb a6 	. . 
	ld hl,04e28h		;4250	21 28 4e 	! ( N 
	push hl			;4253	e5 	. 
	ld hl,(BASIC_BUF)		;4254	2a 5e f5 	* ^ . 
EXEC_JUMP_TO_COMPILED_CODE:
	jp (hl)			;4257	e9 	. 
sub_4258h:
	call sub_6030h		;4258	cd 30 60 	. 0 ` 
	and a			;425b	a7 	. 
	ret z			;425c	c8 	. 
	cp 03ah		;425d	fe 3a 	. : 
	scf			;425f	37 	7 
	ret z			;4260	c8 	. 
	push af			;4261	f5 	. 
	ld a,(VAR_DUMMY)		;4262	3a 64 f5 	: d . 
	and a			;4265	a7 	. 
	jr z,l4270h		;4266	28 08 	( . 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;4268	cd 56 60 	. V ` 
	call sub_6c25h		;426b	cd 25 6c 	. % l 
	nop			;426e	00 	. 
	nop			;426f	00 	. 
l4270h:
	pop af			;4270	f1 	. 
	inc ix		;4271	dd 23 	. # 
	cp 05fh		;4273	fe 5f 	. _ 
	jr nz,l427ch		;4275	20 05 	  . 
	call sub_4e36h		;4277	cd 36 4e 	. 6 N 
	jr l42cch		;427a	18 50 	. P 
l427ch:
	and a			;427c	a7 	. 
	jp m,l4285h		;427d	fa 85 42 	. . B 
	call sub_4464h		;4280	cd 64 44 	. d D 
	jr l42cch		;4283	18 47 	. G 
l4285h:
	cp 0ffh		;4285	fe ff 	. . 
	jr nz,l42b8h		;4287	20 2f 	  / 
	ld a,(ix+000h)		;4289	dd 7e 00 	. ~ . 
	inc ix		;428c	dd 23 	. # 
	ld hl,l42cch		;428e	21 cc 42 	! . B 
	push hl			;4291	e5 	. 
	cp 083h		;4292	fe 83 	. . 
	jp z,l61b4h		;4294	ca b4 61 	. . a 
	cp 0a3h		;4297	fe a3 	. . 
	jp z,l4d2fh		;4299	ca 2f 4d 	. / M 
	cp 085h		;429c	fe 85 	. . 
	jp nz,04e16h		;429e	c2 16 4e 	. . N 
	ld a,045h		;42a1	3e 45 	> E 
	call sub_6048h		;42a3	cd 48 60 	. H ` 
	ld a,052h		;42a6	3e 52 	> R 
	call sub_6048h		;42a8	cd 48 60 	. H ` 
	ld a,0ffh		;42ab	3e ff 	> . 
	call sub_6048h		;42ad	cd 48 60 	. H ` 
	ld a,094h		;42b0	3e 94 	> . 
	call sub_6048h		;42b2	cd 48 60 	. H ` 
	jp CMD_ON_INTERVAL		;42b5	c3 1d 4d 	. . M 
l42b8h:
	cp 0d9h		;42b8	fe d9 	. . 
	jp nc,04e16h		;42ba	d2 16 4e 	. . N 
	add a,a			;42bd	87 	. 
	ld l,a			;42be	6f 	o 
	ld h,000h		;42bf	26 00 	& . 
	ld bc,l4097h		;42c1	01 97 40 	. . @ 
	add hl,bc			;42c4	09 	. 
	ld a,(hl)			;42c5	7e 	~ 
	inc hl			;42c6	23 	# 
	ld h,(hl)			;42c7	66 	f 
	ld l,a			;42c8	6f 	o 
	call sub_42d8h		;42c9	cd d8 42 	. . B 
l42cch:
	call sub_6030h		;42cc	cd 30 60 	. 0 ` 
	and a			;42cf	a7 	. 
	ret z			;42d0	c8 	. 
	cp 03ah		;42d1	fe 3a 	. : 
	scf			;42d3	37 	7 
	ret z			;42d4	c8 	. 
	jp 04e16h		;42d5	c3 16 4e 	. . N 
sub_42d8h:
	jp (hl)			;42d8	e9 	. 
sub_42d9h:
	push ix		;42d9	dd e5 	. . 
	ld ix,(VAR_ARGT)		;42db	dd 2a 6f f5 	. * o . 
l42dfh:
	ld a,(ix+000h)		;42df	dd 7e 00 	. ~ . 
	and (ix+001h)		;42e2	dd a6 01 	. . . 
	inc a			;42e5	3c 	< 
	jr z,l42fbh		;42e6	28 13 	( . 
	ld a,l			;42e8	7d 	} 
	cp (ix+000h)		;42e9	dd be 00 	. . . 
	jr nz,l42f4h		;42ec	20 06 	  . 
	ld a,h			;42ee	7c 	| 
	cp (ix+001h)		;42ef	dd be 01 	. . . 
	jr z,l4310h		;42f2	28 1c 	( . 
l42f4h:
	ld bc,00006h		;42f4	01 06 00 	. . . 
	add ix,bc		;42f7	dd 09 	. . 
	jr l42dfh		;42f9	18 e4 	. . 
l42fbh:
	ld (ix+000h),l		;42fb	dd 75 00 	. u . 
	ld (ix+001h),h		;42fe	dd 74 01 	. t . 
	xor a			;4301	af 	. 
	ld (ix+004h),a		;4302	dd 77 04 	. w . 
	ld (ix+005h),a		;4305	dd 77 05 	. w . 
	ld (ix+006h),0ffh		;4308	dd 36 06 ff 	. 6 . . 
	ld (ix+007h),0ffh		;430c	dd 36 07 ff 	. 6 . . 
l4310h:
	ld hl,(0f560h)		;4310	2a 60 f5 	* ` . 
	ld (ix+002h),l		;4313	dd 75 02 	. u . 
	ld (ix+003h),h		;4316	dd 74 03 	. t . 
	pop ix		;4319	dd e1 	. . 
	ret			;431b	c9 	. 
sub_431ch:
	push ix		;431c	dd e5 	. . 
	ld ix,(VAR_ARGT)		;431e	dd 2a 6f f5 	. * o . 
l4322h:
	ld a,(ix+000h)		;4322	dd 7e 00 	. ~ . 
	and (ix+001h)		;4325	dd a6 01 	. . . 
	inc a			;4328	3c 	< 
	jr z,l433eh		;4329	28 13 	( . 
	ld a,l			;432b	7d 	} 
	cp (ix+000h)		;432c	dd be 00 	. . . 
	jr nz,l4337h		;432f	20 06 	  . 
	ld a,h			;4331	7c 	| 
	cp (ix+001h)		;4332	dd be 01 	. . . 
	jr z,l4360h		;4335	28 29 	( ) 
l4337h:
	ld bc,00006h		;4337	01 06 00 	. . . 
	add ix,bc		;433a	dd 09 	. . 
	jr l4322h		;433c	18 e4 	. . 
l433eh:
	ld (ix+000h),l		;433e	dd 75 00 	. u . 
l4341h:
	ld (ix+001h),h		;4341	dd 74 01 	. t . 
	xor a			;4344	af 	. 
	ld (ix+002h),a		;4345	dd 77 02 	. w . 
	ld (ix+003h),a		;4348	dd 77 03 	. w . 
	ld hl,(0f560h)		;434b	2a 60 f5 	* ` . 
	ld (ix+004h),l		;434e	dd 75 04 	. u . 
	ld (ix+005h),h		;4351	dd 74 05 	. t . 
	ld (ix+006h),0ffh		;4354	dd 36 06 ff 	. 6 . . 
	ld (ix+007h),0ffh		;4358	dd 36 07 ff 	. 6 . . 
	ld l,a			;435c	6f 	o 
	ld h,a			;435d	67 	g 
	jr l4381h		;435e	18 21 	. ! 
l4360h:
	ld a,(ix+002h)		;4360	dd 7e 02 	. ~ . 
	or (ix+003h)		;4363	dd b6 03 	. . . 
	jr z,l4370h		;4366	28 08 	( . 
	ld l,(ix+002h)		;4368	dd 6e 02 	. n . 
	ld h,(ix+003h)		;436b	dd 66 03 	. f . 
	jr l4381h		;436e	18 11 	. . 
l4370h:
	ld l,(ix+004h)		;4370	dd 6e 04 	. n . 
	ld h,(ix+005h)		;4373	dd 66 05 	. f . 
	push hl			;4376	e5 	. 
	ld hl,(0f560h)		;4377	2a 60 f5 	* ` . 
	ld (ix+004h),l		;437a	dd 75 04 	. u . 
	ld (ix+005h),h		;437d	dd 74 05 	. t . 
	pop hl			;4380	e1 	. 
l4381h:
	call sub_60ach		;4381	cd ac 60 	. . ` 
	pop ix		;4384	dd e1 	. . 
	ret			;4386	c9 	. 
sub_4387h:
	ld ix,(VAR_ARGT)		;4387	dd 2a 6f f5 	. * o . 
l438bh:
	ld a,(ix+000h)		;438b	dd 7e 00 	. ~ . 
	and (ix+001h)		;438e	dd a6 01 	. . . 
	inc a			;4391	3c 	< 
	ret z			;4392	c8 	. 
	ld e,(ix+002h)		;4393	dd 5e 02 	. ^ . 
	ld d,(ix+003h)		;4396	dd 56 03 	. V . 
	ld a,e			;4399	7b 	{ 
	or d			;439a	b2 	. 
	jp z,04e19h		;439b	ca 19 4e 	. . N 
	ld l,(ix+004h)		;439e	dd 6e 04 	. n . 
	ld h,(ix+005h)		;43a1	dd 66 05 	. f . 
	ld a,l			;43a4	7d 	} 
	or h			;43a5	b4 	. 
	jr z,l43b3h		;43a6	28 0b 	( . 
l43a8h:
	ld c,(hl)			;43a8	4e 	N 
	ld (hl),e			;43a9	73 	s 
	inc hl			;43aa	23 	# 
	...
	ld a,l			;43af	7d 	} 
	or h			;43b0	b4 	. 
	jr nz,l43a8h		;43b1	20 f5 	  . 
l43b3h:
	ld bc,00006h		;43b3	01 06 00 	. . . 
	add ix,bc		;43b6	dd 09 	. . 
	jr l438bh		;43b8	18 d1 	. . 
	ld a,(ix+000h)		;43ba	dd 7e 00 	. ~ . 
	cp 0e6h		;43bd	fe e6 	. . 
	jr nz,l43c3h		;43bf	20 02 	  . 
	inc ix		;43c1	dd 23 	. # 
l43c3h:
	call sub_6030h		;43c3	cd 30 60 	. 0 ` 
	cp 023h		;43c6	fe 23 	. # 
...
l43d7h:
	inc ix		;43d7	dd 23 	. # 
	call sub_6030h		;43d9	cd 30 60 	. 0 ` 
	push ix		;43dc	dd e5 	. . 
	pop de			;43de	d1 	. 
	...
	call sub_6501h		;43ee	cd 01 65 	. . e 
...
l4410h:
	pop ix		;4410	dd e1 	. . 
l4412h:
	call sub_6030h		;4412	cd 30 60 	. 0 ` 
	cp 02ch		;4415	fe 2c 	. , 
...
l4453h:
	...
	pop ix		;445c	dd e1 	. . 
	ret			;445e	c9 	. 
	call sub_6030h		;445f	cd 30 60 	. 0 ` 
	inc ix		;4462	dd 23 	. # 
sub_4464h:
	dec ix		;4464	dd 2b 	. + 
	call sub_5bf1h		;4466	cd f1 5b 	. . [ 
	push af			;4469	f5 	. 
	call sub_603ah		;446a	cd 3a 60 	. : ` 
	pop af			;446d	f1 	. 
	inc b			;446e	04 	. 
...
l4519h:
	...
	call sub_6030h		;4522	cd 30 60 	. 0 ` 
	cp 02ch		;4525	fe 2c 	. , 
	ret nz			;4527	c0 	. 
	inc ix		;4528	dd 23 	. # 
	jr l4519h		;452a	18 ed 	. . 
l452ch:
	ld a,(VAR_FNPTR)		;452c	3a 62 f5 	: b . 
	and a			;452f	a7 	. 
	jp nz,04e22h		;4530	c2 22 4e 	. " N 
	call sub_6501h		;4533	cd 01 65 	. . e 
	ld (0f577h),hl		;4536	22 77 f5 	" w . 
	call sub_6042h		;4539	cd 42 60 	. B ` 
...
l453eh:
	...
	push hl			;454e	e5 	. 
	inc d			;454f	14 	. 
	call sub_6030h		;4550	cd 30 60 	. 0 ` 
	inc ix		;4553	dd 23 	. # 
	cp 029h		;4555	fe 29 	. ) 
...
l45cah:
	...
	call sub_6030h		;45d2	cd 30 60 	. 0 ` 
	cp 02ch		;45d5	fe 2c 	. , 
	ret nz			;45d7	c0 	. 
	inc ix		;45d8	dd 23 	. # 
	jp l452ch		;45da	c3 2c 45 	. , E 
	call sub_4fdah		;45dd	cd da 4f 	. . O 
	call sub_6030h		;45e0	cd 30 60 	. 0 ` 
	cp 089h		;45e3	fe 89 	. . 
	jr z,l45ech		;45e5	28 05 	( . 
	ld a,0dah		;45e7	3e da 	> . 
	call sub_6048h		;45e9	cd 48 60 	. H ` 
l45ech:
	ld a,b			;45ec	78 	x 
	cp 002h		;45ed	fe 02 	. . 
...
l4601h:
	...
	push hl			;460c	e5 	. 
	call sub_6030h		;460d	cd 30 60 	. 0 ` 
	cp 00dh		;4610	fe 0d 	. . 
	jr z,l4618h		;4612	28 04 	( . 
	cp 00eh		;4614	fe 0e 	. . 
	jr nz,l4623h		;4616	20 0b 	  . 
l4618h:
	call sub_4696h		;4618	cd 96 46 	. . F 
...
l4626h:
	...
	inc ix		;4629	dd 23 	. # 
	call sub_6030h		;462b	cd 30 60 	. 0 ` 
	cp 0a1h		;462e	fe a1 	. . 
	...
	dec hl			;4644	2b 	+ 
	ld (hl),e			;4645	73 	s 
	call sub_6030h		;4646	cd 30 60 	. 0 ` 
	cp 00dh		;4649	fe 0d 	. . 
	jr z,l4651h		;464b	28 04 	( . 
	cp 00eh		;464d	fe 0e 	. . 
	jr nz,l465ch		;464f	20 0b 	  . 
l4651h:
	call sub_4696h		;4651	cd 96 46 	. . F 
...
l465fh:
	...
	inc ix		;4665	dd 23 	. # 
	call sub_6030h		;4667	cd 30 60 	. 0 ` 
	cp 0a1h		;466a	fe a1 	. . 
...
sub_469bh:
	...
	call sub_6030h		;469e	cd 30 60 	. 0 ` 
...
l46bdh:
	...
	call sub_6030h		;46c0	cd 30 60 	. 0 ` 
	push ix		;46c3	dd e5 	. . 
	pop hl			;46c5	e1 	. 
	...
	call sub_4f54h		;46d4	cd 54 4f 	. T O 
	...
	push hl			;46e3	e5 	. 
	call sub_6030h		;46e4	cd 30 60 	. 0 ` 
	cp 089h		;46e7	fe 89 	. . 
...
l46ebh:
	...
	call sub_6030h		;46f8	cd 30 60 	. 0 ` 
	cp 02ch		;46fb	fe 2c 	. , 
...
l4709h:
	...
	push hl			;4721	e5 	. 
	call sub_6030h		;4722	cd 30 60 	. 0 ` 
	cp 02ch		;4725	fe 2c 	. , 
...
l4744h:
	...
	call sub_6048h		;474b	cd 48 60 	. H ` 
l474eh:
	call sub_6030h		;474e	cd 30 60 	. 0 ` 
	cp 02ch		;4751	fe 2c 	. , 
	jr z,l478eh		;4753	28 39 	( 9 
	ld a,021h		;4755	3e 21 	> ! 
	call WRITE_OPCODE		;4757	cd b7 60 	. . ` 
	call sub_6030h		;475a	cd 30 60 	. 0 ` 
...
l477ch:
	...
	call sub_6030h		;4788	cd 30 60 	. 0 ` 
	cp 02ch		;478b	fe 2c 	. , 
	ret nz			;478d	c0 	. 
l478eh:
	inc ix		;478e	dd 23 	. # 
...
l47a2h:
	...
	ld c,a			;47a5	4f 	O 
	inc ix		;47a6	dd 23 	. # 
	call sub_6030h		;47a8	cd 30 60 	. 0 ` 
	cp 0f2h		;47ab	fe f2 	. . 
...
l47c2h:
	...
	call sub_6030h		;47c7	cd 30 60 	. 0 ` 
	cp 02ch		;47ca	fe 2c 	. , 
	ret nz			;47cc	c0 	. 
	inc ix		;47cd	dd 23 	. # 
	jr l47a2h		;47cf	18 d1 	. . 
sub_47d1h:
	call sub_6030h		;47d1	cd 30 60 	. 0 ` 
...
l480bh:
	...
	call sub_6501h		;480e	cd 01 65 	. . e 
	call sub_603ah		;4811	cd 3a 60 	. : ` 
	push hl			;4814	e5 	. 
	...
	call sub_6048h		;4824	cd 48 60 	. H ` 
...
l4849h:
	call sub_6030h		;4849	cd 30 60 	. 0 ` 
	cp 0dch		;484c	fe dc 	. . 
...
l487fh:
	...
	call sub_6048h		;4889	cd 48 60 	. H ` 
	...
	call sub_6030h		;489c	cd 30 60 	. 0 ` 
	cp 0dch		;489f	fe dc 	. . 
...
l48bfh:
	call sub_6501h		;48bf	cd 01 65 	. . e 
...
l4914h:
	call sub_6030h		;4914	cd 30 60 	. 0 ` 
	cp 02ch		;4917	fe 2c 	. , 
	ret nz			;4919	c0 	. 
	inc ix		;491a	dd 23 	. # 
	jr l48bfh		;491c	18 a1 	. . 
l491eh:
	push hl			;491e	e5 	. 
...
l4a5eh:
	...
	nop			;4a69	00 	. 
	ret			;4a6a	c9 	. 
	call sub_6030h		;4a6b	cd 30 60 	. 0 ` 
	cp 022h		;4a6e	fe 22 	. " 
	...
	call sub_6048h		;4a7f	cd 48 60 	. H ` 
...
sub_4a88h:
	...
	push de			;4a89	d5 	. 
	push ix		;4a8a	dd e5 	. . 
	call sub_6501h		;4a8c	cd 01 65 	. . e 
	pop ix		;4a8f	dd e1 	. . 
...
l4b10h:
	...
	nop			;4b25	00 	. 
	nop			;4b26	00 	. 
	call sub_4b34h		;4b27	cd 34 4b 	. 4 K 
...
l4c94h:
	...
	nop			;4cad	00 	. 
	nop			;4cae	00 	. 
	call sub_603eh		;4caf	cd 3e 60 	. > ` 
	call sub_4f54h		;4cb2	cd 54 4f 	. T O 
	call sub_6030h		;4cb5	cd 30 60 	. 0 ` 
	cp 02ch		;4cb8	fe 2c 	. , 
...
l4cc9h:
	...
	nop			;4ccf	00 	. 
	nop			;4cd0	00 	. 
	call sub_4f54h		;4cd1	cd 54 4f 	. T O 
...
l4cdah:
	...
	call sub_6048h		;4ce5	cd 48 60 	. H ` 
	call sub_6030h		;4ce8	cd 30 60 	. 0 ` 
...
CMD_ON_INTERVAL:
	...
	call sub_6030h		;4d22	cd 30 60 	. 0 ` 
	cp 024h		;4d25	fe 24 	. $ 
...
l4d2fh:
	...
	call sub_6030h		;4d34	cd 30 60 	. 0 ` 
	cp 095h		;4d37	fe 95 	. . 
...
l4d58h:
	push de			;4d58	d5 	. 
	call sub_6042h		;4d59	cd 42 60 	. B ` 
	call sub_4fa9h		;4d5c	cd a9 4f 	. . O 
	call sub_6046h		;4d5f	cd 46 60 	. F ` 
	pop de			;4d62	d1 	. 
	inc b			;4d63	04 	. 
...
l4d6fh:
	...
	nop			;4d84	00 	. 
l4d85h:
	call sub_6030h		;4d85	cd 30 60 	. 0 ` 
	inc ix		;4d88	dd 23 	. # 
	cp 095h		;4d8a	fe 95 	. . 
...
l4da0h:
	...
	call sub_4f54h		;4da5	cd 54 4f 	. T O 
	call sub_603eh		;4da8	cd 3e 60 	. > ` 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;4dab	cd 56 60 	. V ` 
	push af			;4dae	f5 	. 
	nop			;4daf	00 	. 
	nop			;4db0	00 	. 
	call sub_4f54h		;4db1	cd 54 4f 	. T O 
WRITE_CMD_SOUND:
...
l4dc1h:
	...
	nop			;4dc5	00 	. 
	ret			;4dc6	c9 	. 
	call sub_6030h		;4dc7	cd 30 60 	. 0 ` 
	call sub_4f54h		;4dca	cd 54 4f 	. T O 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;4dcd	cd 56 60 	. V ` 
	push af			;4dd0	f5 	. 
	nop			;4dd1	00 	. 
	nop			;4dd2	00 	. 
	call sub_603eh		;4dd3	cd 3e 60 	. > ` 
	call sub_4f54h		;4dd6	cd 54 4f 	. T O 
...
sub_4e36h:
	...
	call sub_6030h		;4e3d	cd 30 60 	. 0 ` 
...
l4e5dh:
	...
	call sub_6030h		;4e79	cd 30 60 	. 0 ` 
	and a			;4e7c	a7 	. 
...
PARSE_LINE:
	call sub_6501h		;4e97	cd 01 65 	. . e 
	ld a,h			;4e9a	7c 	| 
	and 060h		;4e9b	e6 60 	. ` 
...
l4ea9h:
	...
	call sub_6030h		;4eab	cd 30 60 	. 0 ` 
	cp 028h		;4eae	fe 28 	. ( 
...
l4ecah:
	call sub_6030h		;4eca	cd 30 60 	. 0 ` 
	inc ix		;4ecd	dd 23 	. # 
	cp 02ch		;4ecf	fe 2c 	. , 
...
l4edbh:
	inc ix		;4edb	dd 23 	. # 
	call sub_6046h		;4edd	cd 46 60 	. F ` 
...
CMD_CALL_TURBO_OFF:
	ret			;4eff	c9 	. 
sub_4f00h:
	call sub_6030h		;4f00	cd 30 60 	. 0 ` 
sub_4f03h:
	and a			;4f03	a7 	. 
	ret z			;4f04	c8 	. 
	cp 03ah		;4f05	fe 3a 	. : 
...
l4fc4h:
	...
	dec b			;4fc5	05 	. 
	ret nz			;4fc6	c0 	. 
	call sub_782dh		;4fc7	cd 2d 78 	. - x 
l4fcah:
...
l5015h:
	call sub_6030h		;5015	cd 30 60 	. 0 ` 
	cp 0f8h		;5018	fe f8 	. . 
	ret nz			;501a	c0 	. 
...
l5028h:
	call sub_6030h		;5028	cd 30 60 	. 0 ` 
	cp 0f7h		;502b	fe f7 	. . 
	ret nz			;502d	c0 	. 
...
l503bh:
	call sub_6030h		;503b	cd 30 60 	. 0 ` 
	cp 0f6h		;503e	fe f6 	. . 
	ret nz			;5040	c0 	. 
...
l5050h:
	call sub_6030h		;5050	cd 30 60 	. 0 ` 
	sub 0eeh		;5053	d6 ee 	. . 
...
l5123h:
	...
	call sub_6030h		;5126	cd 30 60 	. 0 ` 
	cp 0f1h		;5129	fe f1 	. . 
...
l525bh:
	call sub_6030h		;525b	cd 30 60 	. 0 ` 
	cp 0fbh		;525e	fe fb 	. . 
	ret nz			;5260	c0 	. 
...
l52e1h:
	call sub_6030h		;52e1	cd 30 60 	. 0 ` 
	cp 0fch		;52e4	fe fc 	. . 
	ret nz			;52e6	c0 	. 
...
l53f4h:
	...
	call sub_6030h		;53f7	cd 30 60 	. 0 ` 
	cp 0f4h		;53fa	fe f4 	. . 
...
l542ah:
	...
	push de			;5453	d5 	. 
	call sub_782dh		;5454	cd 2d 78 	. - x 
	pop de			;5457	d1 	. 
	push hl			;5458	e5 	. 
	push bc			;5459	c5 	. 
	ex de,hl			;545a	eb 	. 
	call sub_782dh		;545b	cd 2d 78 	. - x 
	pop de			;545e	d1 	. 
	ld c,d			;545f	4a 	J 
	pop de			;5460	d1 	. 
	...
	call sub_782dh		;546d	cd 2d 78 	. - x 
	ld c,b			;5470	48 	H 
	ex de,hl			;5471	eb 	. 
	nop			;5472	00 	. 
	nop			;5473	00 	. 
	ex de,hl			;5474	eb 	. 
	call sub_782dh		;5475	cd 2d 78 	. - x 
	...
	call sub_782dh		;5485	cd 2d 78 	. - x 
	...
	call sub_782dh		;549d	cd 2d 78 	. - x 
	push hl			;54a0	e5 	. 
	push bc			;54a1	c5 	. 
	nop			;54a2	00 	. 
	nop			;54a3	00 	. 
	...
	call sub_782dh		;54b0	cd 2d 78 	. - x 
	pop de			;54b3	d1 	. 
	push hl			;54b4	e5 	. 
	push bc			;54b5	c5 	. 
	ex de,hl			;54b6	eb 	. 
...
l54b9h:
	...
	call sub_782dh		;54bc	cd 2d 78 	. - x 
	pop de			;54bf	d1 	. 
	ld c,d			;54c0	4a 	J 
	pop de			;54c1	d1 	. 
	nop			;54c2	00 	. 
...
l5623h:
	call sub_6030h		;5623	cd 30 60 	. 0 ` 
	cp 0f5h		;5626	fe f5 	. . 
	ret nz			;5628	c0 	. 
...
l5640h:
	...
	push hl			;5655	e5 	. 
	ex de,hl			;5656	eb 	. 
	call sub_782dh		;5657	cd 2d 78 	. - x 
	pop de			;565a	d1 	. 
	...
	push hl			;5664	e5 	. 
	ex de,hl			;5665	eb 	. 
	call sub_782dh		;5666	cd 2d 78 	. - x 
	...
	nop			;5675	00 	. 
	ex de,hl			;5676	eb 	. 
	call sub_782dh		;5677	cd 2d 78 	. - x 
	...
	call sub_782dh		;569a	cd 2d 78 	. - x 
	pop de			;569d	d1 	. 
	nop			;569e	00 	. 
	nop			;569f	00 	. 
...
l56adh:
	...
	ex (sp),hl			;56b5	e3 	. 
	call sub_782dh		;56b6	cd 2d 78 	. - x 
	pop de			;56b9	d1 	. 
	nop			;56ba	00 	. 
	nop			;56bb	00 	. 
l56bch:
...
sub_56eah:
	...
	call sub_6030h		;56f6	cd 30 60 	. 0 ` 
	inc ix		;56f9	dd 23 	. # 
	cp 028h		;56fb	fe 28 	. ( 
	jr nz,l5705h		;56fd	20 06 	  . 
	call sub_5012h		;56ff	cd 12 50 	. . P 
	jp sub_6046h		;5702	c3 46 60 	. F ` 
l5705h:
...
l5768h:
	...
	ld h,b			;5775	60 	` 
l5776h:
	call sub_6030h		;5776	cd 30 60 	. 0 ` 
...
l586dh:
	...
	dec ix		;5877	dd 2b 	. + 
	call sub_6501h		;5879	cd 01 65 	. . e 
	cp 028h		;587c	fe 28 	. ( 
...
l59b2h:
	...
	ld h,(hl)			;59f1	66 	f 
	ld l,a			;59f2	6f 	o 
	call sub_6042h		;59f3	cd 42 60 	. B ` 
	jp (hl)			;59f6	e9 	. 
l59f7h:
...
l5a78h:
	...
	ret			;5a7b	c9 	. 
sub_5a7ch:
	call sub_6030h		;5a7c	cd 30 60 	. 0 ` 
	inc ix		;5a7f	dd 23 	. # 
	and a			;5a81	a7 	. 
...
l5acbh:
	...
	ld hl,l7678h		;5ad1	21 78 76 	! x v 
	jr l5af7h		;5ad4	18 21 	. ! 
	ld hl,l79fah		;5ad6	21 fa 79 	! . y 
	jr l5af7h		;5ad9	18 1c 	. . 
	ld hl,l7a53h		;5adb	21 53 7a 	! S z 
	jr l5af7h		;5ade	18 17 	. . 
	ld hl,l7936h		;5ae0	21 36 79 	! 6 y 
	jr l5af7h		;5ae3	18 12 	. . 
	ld hl,l792eh		;5ae5	21 2e 79 	! . y 
	jr l5af7h		;5ae8	18 0d 	. . 
	ld hl,l7990h		;5aea	21 90 79 	! . y 
	jr l5af7h		;5aed	18 08 	. . 
	ld hl,079b2h		;5aef	21 b2 79 	! . y 
	jr l5af7h		;5af2	18 03 	. . 
	ld hl,l7ab5h		;5af4	21 b5 7a 	! . z 
l5af7h:
	push hl			;5af7	e5 	. 
	call sub_4faeh		;5af8	cd ae 4f 	. . O 
	call sub_6046h		;5afb	cd 46 60 	. F ` 
	pop hl			;5afe	e1 	. 
	jp l53ech		;5aff	c3 ec 53 	. . S 
	call sub_4fdah		;5b02	cd da 4f 	. . O 
	call sub_6046h		;5b05	cd 46 60 	. F ` 
	ld a,b			;5b08	78 	x 
	cp 002h		;5b09	fe 02 	. . 
	ret z			;5b0b	c8 	. 
	...
	call sub_6046h		;5b18	cd 46 60 	. F ` 
	ld a,b			;5b1b	78 	x 
	cp 002h		;5b1c	fe 02 	. . 
	ret z			;5b1e	c8 	. 
	...
	call sub_6046h		;5b2b	cd 46 60 	. F ` 
	ld a,b			;5b2e	78 	x 
	cp 002h		;5b2f	fe 02 	. . 
...
l5b45h:
	...
	call sub_6046h		;5b52	cd 46 60 	. F ` 
	ld a,b			;5b55	78 	x 
	cp 002h		;5b56	fe 02 	. . 
...
l5b7eh:
	...
	call sub_6046h		;5b86	cd 46 60 	. F ` 
...
l5b8fh:
	...
	call sub_6046h		;5b9c	cd 46 60 	. F ` 
	inc b			;5b9f	04 	. 
...
l5bd1h:
	call sub_6042h		;5bd1	cd 42 60 	. B ` 
	call sub_5bdch		;5bd4	cd dc 5b 	. . [ 
	ld b,002h		;5bd7	06 02 	. . 
	jp sub_6046h		;5bd9	c3 46 60 	. F ` 
sub_5bdch:
...
l5befh:
	...
	ret			;5bf0	c9 	. 
sub_5bf1h:
	call sub_6501h		;5bf1	cd 01 65 	. . e 
	cp 028h		;5bf4	fe 28 	. ( 
...
l5c46h:
	...
	ret			;5c52	c9 	. 
l5c53h:
	call sub_6030h		;5c53	cd 30 60 	. 0 ` 
	...
	inc ix		;5c61	dd 23 	. # 
l5c63h:
	call sub_6042h		;5c63	cd 42 60 	. B ` 
	push bc			;5c66	c5 	. 
	call sub_4f97h		;5c67	cd 97 4f 	. . O 
	pop bc			;5c6a	c1 	. 
	call sub_6046h		;5c6b	cd 46 60 	. F ` 
...
l5c91h:
	...
	call sub_6046h		;5cc8	cd 46 60 	. F ` 
	inc b			;5ccb	04 	. 
...
l5d0dh:
	...
	ret			;5d11	c9 	. 
	call sub_4f54h		;5d12	cd 54 4f 	. T O 
	call sub_6046h		;5d15	cd 46 60 	. F ` 
...
sub_6030h:
	...
	ret nz			;6035	c0 	. 
	inc ix		;6036	dd 23 	. # 
	jr sub_6030h		;6038	18 f6 	. . 
sub_603ah:
	ld a,0efh		;603a	3e ef 	> . 
	jr sub_6048h		;603c	18 0a 	. . 
sub_603eh:
	ld a,02ch		;603e	3e 2c 	> , 
	jr sub_6048h		;6040	18 06 	. . 
sub_6042h:
	ld a,028h		;6042	3e 28 	> ( 
	jr sub_6048h		;6044	18 02 	. . 
sub_6046h:
	ld a,029h		;6046	3e 29 	> ) 
sub_6048h:
	push af			;6048	f5 	. 
	call sub_6030h		;6049	cd 30 60 	. 0 ` 
	pop af			;604c	f1 	. 
...
sub_60d5h:
	...
	nop			;60e5	00 	. 
	ex de,hl			;60e6	eb 	. 
	call sub_782dh		;60e7	cd 2d 78 	. - x 
	...
	call sub_782dh		;6107	cd 2d 78 	. - x 
...
sub_613eh:
	...
	call sub_782dh		;6141	cd 2d 78 	. - x 
	nop			;6144	00 	. 
	nop			;6145	00 	. 
	ret			;6146	c9 	. 
...
l614fh:
	...
	call sub_603eh		;6153	cd 3e 60 	. > ` 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;6156	cd 56 60 	. V ` 
	push hl			;6159	e5 	. 
	nop			;615a	00 	. 
	nop			;615b	00 	. 
	call sub_4f54h		;615c	cd 54 4f 	. T O 
	call sub_6046h		;615f	cd 46 60 	. F ` 
	...
	call sub_603eh		;6174	cd 3e 60 	. > ` 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;6177	cd 56 60 	. V ` 
	push hl			;617a	e5 	. 
	nop			;617b	00 	. 
	nop			;617c	00 	. 
	call sub_4f54h		;617d	cd 54 4f 	. T O 
	call sub_6030h		;6180	cd 30 60 	. 0 ` 
	cp 02ch		;6183	fe 2c 	. , 
	...
	nop			;618d	00 	. 
	nop			;618e	00 	. 
	call sub_4f54h		;618f	cd 54 4f 	. T O 
	call sub_6046h		;6192	cd 46 60 	. F ` 
...
l619dh:
	call sub_6046h		;619d	cd 46 60 	. F ` 
...
l61dfh:
	...
	nop			;61e5	00 	. 
l61e6h:
	call sub_6046h		;61e6	cd 46 60 	. F ` 
	call sub_603ah		;61e9	cd 3a 60 	. : ` 
...
l620eh:
	...
	ld hl,l7dffh		;6219	21 ff 7d 	! . } 
l621ch:
	push hl			;621c	e5 	. 
	call sub_4f54h		;621d	cd 54 4f 	. T O 
l6220h:
	call sub_6046h		;6220	cd 46 60 	. F ` 
	pop hl			;6223	e1 	. 
	jr l6269h		;6224	18 43 	. C 
l6226h:
	call sub_6042h		;6226	cd 42 60 	. B ` 
	call sub_4f54h		;6229	cd 54 4f 	. T O 
	call sub_603eh		;622c	cd 3e 60 	. > ` 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;622f	cd 56 60 	. V ` 
	push af			;6232	f5 	. 
	nop			;6233	00 	. 
	nop			;6234	00 	. 
	call sub_5012h		;6235	cd 12 50 	. . P 
	call sub_6046h		;6238	cd 46 60 	. F ` 
	ld a,b			;623b	78 	x 
	cp 004h		;623c	fe 04 	. . 
...
l624ch:
	...
	call sub_6046h		;625b	cd 46 60 	. F ` 
	ld a,b			;625e	78 	x 
	cp 002h		;625f	fe 02 	. . 
...
l6269h:
	...
	call sub_6046h		;6274	cd 46 60 	. F ` 
	...
	call sub_6046h		;6285	cd 46 60 	. F ` 
	...
	call sub_6046h		;6297	cd 46 60 	. F ` 
	...
	ret			;62a4	c9 	. 
l62a5h:
	call sub_6042h		;62a5	cd 42 60 	. B ` 
	call sub_5012h		;62a8	cd 12 50 	. . P 
	call sub_603eh		;62ab	cd 3e 60 	. > ` 
	ld a,b			;62ae	78 	x 
	cp 004h		;62af	fe 04 	. . 
...
l62cch:
	...
	call sub_6046h		;62d5	cd 46 60 	. F ` 
...
sub_6501h:
	call sub_6030h		;6501	cd 30 60 	. 0 ` 
...
l6514h:
	inc ix		;6514	dd 23 	. # 
	call sub_6030h		;6516	cd 30 60 	. 0 ` 
	cp 021h		;6519	fe 21 	. ! 
...
l6592h:
	...
	inc ix		;65b2	dd 23 	. # 
	call sub_6030h		;65b4	cd 30 60 	. 0 ` 
	inc ix		;65b7	dd 23 	. # 
	cp 094h		;65b9	fe 94 	. . 
	...
	call sub_4f54h		;65c8	cd 54 4f 	. T O 
	call sub_6a6dh		;65cb	cd 6d 6a 	. m j 
	call sub_603eh		;65ce	cd 3e 60 	. > ` 
	call sub_6030h		;65d1	cd 30 60 	. 0 ` 
	cp 02ch		;65d4	fe 2c 	. , 
	jr z,l65e7h		;65d6	28 0f 	( . 
	call sub_4f54h		;65d8	cd 54 4f 	. T O 
	call sub_6a6dh		;65db	cd 6d 6a 	. m j 
	call sub_6030h		;65de	cd 30 60 	. 0 ` 
	cp 02ch		;65e1	fe 2c 	. , 
...
l65efh:
	inc ix		;65ef	dd 23 	. # 
	call sub_6030h		;65f1	cd 30 60 	. 0 ` 
	cp 02ch		;65f4	fe 2c 	. , 
	jr z,l6607h		;65f6	28 0f 	( . 
	call sub_4f54h		;65f8	cd 54 4f 	. T O 
	call sub_6a6dh		;65fb	cd 6d 6a 	. m j 
	call sub_6030h		;65fe	cd 30 60 	. 0 ` 
	cp 02ch		;6601	fe 2c 	. , 
...
l660fh:
	inc ix		;660f	dd 23 	. # 
	call sub_4f54h		;6611	cd 54 4f 	. T O 
...
l6624h:
	...
	nop			;662a	00 	. 
l662bh:
	call sub_6046h		;662b	cd 46 60 	. F ` 
...
l669bh:
	inc ix		;669b	dd 23 	. # 
	call sub_6030h		;669d	cd 30 60 	. 0 ` 
	cp 024h		;66a0	fe 24 	. $ 
	push af			;66a2	f5 	. 
	jr nz,l66a7h		;66a3	20 02 	  . 
	inc ix		;66a5	dd 23 	. # 
l66a7h:
	call sub_6042h		;66a7	cd 42 60 	. B ` 
	call sub_4f54h		;66aa	cd 54 4f 	. T O 
	call sub_6046h		;66ad	cd 46 60 	. F ` 
	call sub_603ah		;66b0	cd 3a 60 	. : ` 
	call sub_6a6dh		;66b3	cd 6d 6a 	. m j 
	pop af			;66b6	f1 	. 
	jr z,l66c6h		;66b7	28 0d 	( . 
	call sub_4f54h		;66b9	cd 54 4f 	. T O 
...
l66c6h:
	...
	nop			;66d1	00 	. 
	ret			;66d2	c9 	. 
	call sub_6030h		;66d3	cd 30 60 	. 0 ` 
	cp 0f2h		;66d6	fe f2 	. . 
...
l6775h:
	...
	call sub_6030h		;677e	cd 30 60 	. 0 ` 
	cp 02ch		;6781	fe 2c 	. , 
	jr nz,l67beh		;6783	20 39 	  9 
	inc ix		;6785	dd 23 	. # 
	call sub_6030h		;6787	cd 30 60 	. 0 ` 
	cp 02ch		;678a	fe 2c 	. , 
...
sub_67d8h:
	call sub_6030h		;67d8	cd 30 60 	. 0 ` 
	cp 02ch		;67db	fe 2c 	. , 
	jr nz,l680fh		;67dd	20 30 	  0 
	inc ix		;67df	dd 23 	. # 
	call sub_6030h		;67e1	cd 30 60 	. 0 ` 
	inc ix		;67e4	dd 23 	. # 
...
l6816h:
	call sub_6030h		;6816	cd 30 60 	. 0 ` 
	inc ix		;6819	dd 23 	. # 
	cp 0f8h		;681b	fe f8 	. . 
...
l6830h:
	call sub_6030h		;6830	cd 30 60 	. 0 ` 
	inc ix		;6833	dd 23 	. # 
...
l683eh:
	...
	call sub_6048h		;6840	cd 48 60 	. H ` 
	call sub_6030h		;6843	cd 30 60 	. 0 ` 
	inc ix		;6846	dd 23 	. # 
	...
	call sub_603eh		;6854	cd 3e 60 	. > ` 
	call sub_4f97h		;6857	cd 97 4f 	. . O 
	call sub_6030h		;685a	cd 30 60 	. 0 ` 
	cp 02ch		;685d	fe 2c 	. , 
	jr nz,l6870h		;685f	20 0f 	  . 
	inc ix		;6861	dd 23 	. # 
	call sub_6a68h		;6863	cd 68 6a 	. h j 
	call sub_4f54h		;6866	cd 54 4f 	. T O 
...
WRITE_CMD_CIRCLE:
	...
	call sub_6048h		;6880	cd 48 60 	. H ` 
	xor a			;6883	af 	. 
	push af			;6884	f5 	. 
	call sub_4f54h		;6885	cd 54 4f 	. T O 
	call sub_6a6dh		;6888	cd 6d 6a 	. m j 
	call sub_603eh		;688b	cd 3e 60 	. > ` 
	call sub_6030h		;688e	cd 30 60 	. 0 ` 
	cp 02ch		;6891	fe 2c 	. , 
	...
	or 080h		;689f	f6 80 	. . 
	push af			;68a1	f5 	. 
	call sub_6030h		;68a2	cd 30 60 	. 0 ` 
	cp 02ch		;68a5	fe 2c 	. , 
...
l68b2h:
	inc ix		;68b2	dd 23 	. # 
	call sub_6030h		;68b4	cd 30 60 	. 0 ` 
	cp 02ch		;68b7	fe 2c 	. , 
	jr z,l68ceh		;68b9	28 13 	( . 
	call sub_4f54h		;68bb	cd 54 4f 	. T O 
	call sub_6a6dh		;68be	cd 6d 6a 	. m j 
	pop af			;68c1	f1 	. 
	or 040h		;68c2	f6 40 	. @ 
	push af			;68c4	f5 	. 
	call sub_6030h		;68c5	cd 30 60 	. 0 ` 
	cp 02ch		;68c8	fe 2c 	. , 
...
l68d1h:
	inc ix		;68d1	dd 23 	. # 
	call sub_4f54h		;68d3	cd 54 4f 	. T O 
...
l68fah:
	inc ix		;68fa	dd 23 	. # 
	call sub_6042h		;68fc	cd 42 60 	. B ` 
	call sub_4f54h		;68ff	cd 54 4f 	. T O 
	call sub_6046h		;6902	cd 46 60 	. F ` 
	call sub_603ah		;6905	cd 3a 60 	. : ` 
...
l6918h:
	...
	call sub_6048h		;691a	cd 48 60 	. H ` 
	call sub_6042h		;691d	cd 42 60 	. B ` 
	call sub_4f54h		;6920	cd 54 4f 	. T O 
	call sub_6046h		;6923	cd 46 60 	. F ` 
	...
	ret			;6930	c9 	. 
	call sub_6030h		;6931	cd 30 60 	. 0 ` 
	cp 02ch		;6934	fe 2c 	. , 
	jr z,l6949h		;6936	28 11 	( . 
	call sub_4f54h		;6938	cd 54 4f 	. T O 
WRITE_CMD_SCREEN:
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;693b	cd 56 60 	. V ` 
	call CMD_SCREEN		;693e	cd 67 73 	. g s 
	nop			;6941	00 	. 
	nop			;6942	00 	. 
	call sub_6030h		;6943	cd 30 60 	. 0 ` 
	cp 02ch		;6946	fe 2c 	. , 
	ret nz			;6948	c0 	. 
l6949h:
	inc ix		;6949	dd 23 	. # 
	call sub_4f54h		;694b	cd 54 4f 	. T O 
...
WRITE_CMD_CLS:
	...
	call sub_603eh		;695d	cd 3e 60 	. > ` 
	inc b			;6960	04 	. 
	djnz l696dh		;6961	10 0a 	. . 
	push hl			;6963	e5 	. 
	call sub_4f54h		;6964	cd 54 4f 	. T O 
	pop hl			;6967	e1 	. 
...
l696dh:
	...
	push hl			;696f	e5 	. 
	call sub_4f54h		;6970	cd 54 4f 	. T O 
	pop hl			;6973	e1 	. 
...
l699bh:
	...
	call sub_6030h		;69a1	cd 30 60 	. 0 ` 
	cp 053h		;69a4	fe 53 	. S 
	jr z,l69e2h		;69a6	28 3a 	( : 
	ld a,050h		;69a8	3e 50 	> P 
	call sub_6048h		;69aa	cd 48 60 	. H ` 
	ld a,041h		;69ad	3e 41 	> A 
	call sub_6048h		;69af	cd 48 60 	. H ` 
	ld a,047h		;69b2	3e 47 	> G 
	call sub_6048h		;69b4	cd 48 60 	. H ` 
	ld a,045h		;69b7	3e 45 	> E 
	call sub_6048h		;69b9	cd 48 60 	. H ` 
	call sub_6030h		;69bc	cd 30 60 	. 0 ` 
	cp 02ch		;69bf	fe 2c 	. , 
	jr z,l69d4h		;69c1	28 11 	( . 
	call sub_4f54h		;69c3	cd 54 4f 	. T O 
	call WRITE_NEXT_BYTES_UNTIL_2_NOPS		;69c6	cd 56 60 	. V ` 
	call sub_70cah		;69c9	cd ca 70 	. . p 
	nop			;69cc	00 	. 
	nop			;69cd	00 	. 
	call sub_6030h		;69ce	cd 30 60 	. 0 ` 
	cp 02ch		;69d1	fe 2c 	. , 
	ret nz			;69d3	c0 	. 
l69d4h:
	inc ix		;69d4	dd 23 	. # 
	call sub_4f54h		;69d6	cd 54 4f 	. T O 
...
l69e2h:
	...
	call sub_6048h		;69e6	cd 48 60 	. H ` 
	ld a,052h		;69e9	3e 52 	> R 
	call sub_6048h		;69eb	cd 48 60 	. H ` 
	ld a,04fh		;69ee	3e 4f 	> O 
	call sub_6048h		;69f0	cd 48 60 	. H ` 
	ld a,04ch		;69f3	3e 4c 	> L 
	call sub_6048h		;69f5	cd 48 60 	. H ` 
	call sub_6048h		;69f8	cd 48 60 	. H ` 
	...
	call sub_4f54h		;6a0a	cd 54 4f 	. T O 
...
l6a24h:
	...
	call sub_4f54h		;6a2c	cd 54 4f 	. T O 
...
sub_6a6dh:
	...
	call sub_6046h		;6a74	cd 46 60 	. F ` 
	ld b,002h		;6a77	06 02 	. . 
	ld hl,l70a1h		;6a79	21 a1 70 	! . p 
	jp WRITE_CALL		;6a7c	c3 d3 67 	. . g 
	call sub_6042h		;6a7f	cd 42 60 	. B ` 
	call sub_4f54h		;6a82	cd 54 4f 	. T O 
	call sub_6046h		;6a85	cd 46 60 	. F ` 
	call sub_6a6dh		;6a88	cd 6d 6a 	. m j 
	call sub_603ah		;6a8b	cd 3a 60 	. : ` 
	call sub_4f54h		;6a8e	cd 54 4f 	. T O 
...
l6aadh:
	call sub_6042h		;6aad	cd 42 60 	. B ` 
	call sub_4f97h		;6ab0	cd 97 4f 	. . O 
	call sub_6046h		;6ab3	cd 46 60 	. F ` 
	...
	call sub_6030h		;6ac7	cd 30 60 	. 0 ` 
	cp 02ch		;6aca	fe 2c 	. , 
	jr nz,l6b02h		;6acc	20 34 	  4 
	inc ix		;6ace	dd 23 	. # 
	call sub_6030h		;6ad0	cd 30 60 	. 0 ` 
	cp 02ch		;6ad3	fe 2c 	. , 
	jr z,l6af0h		;6ad5	28 19 	( . 
	call sub_4f54h		;6ad7	cd 54 4f 	. T O 
	call sub_6030h		;6ada	cd 30 60 	. 0 ` 
	cp 02ch		;6add	fe 2c 	. , 
	jr nz,l6b0ah		;6adf	20 29 	  ) 
	inc ix		;6ae1	dd 23 	. # 
	call sub_6a6dh		;6ae3	cd 6d 6a 	. m j 
	call sub_4f54h		;6ae6	cd 54 4f 	. T O 
	ld a,0c1h		;6ae9	3e c1 	> . 
	call WRITE_OPCODE		;6aeb	cd b7 60 	. . ` 
	jr WRITE_CMD_PAINT		;6aee	18 20 	.   
l6af0h:
	inc ix		;6af0	dd 23 	. # 
	call sub_4f54h		;6af2	cd 54 4f 	. T O 
...
WRITE_CMD_PAINT:
	...
	call sub_6048h		;6b20	cd 48 60 	. H ` 
	...
	call sub_6030h		;6b32	cd 30 60 	. 0 ` 
	cp 02ch		;6b35	fe 2c 	. , 
	jr nz,l6b40h		;6b37	20 07 	  . 
	inc ix		;6b39	dd 23 	. # 
	call sub_4f54h		;6b3b	cd 54 4f 	. T O 
...
l6b48h:
	...
	call sub_6048h		;6b52	cd 48 60 	. H ` 
	call sub_6b89h		;6b55	cd 89 6b 	. . k 
	call sub_6030h		;6b58	cd 30 60 	. 0 ` 
	cp 02ch		;6b5b	fe 2c 	. , 
	jr nz,l6b6dh		;6b5d	20 0e 	  . 
	inc ix		;6b5f	dd 23 	. # 
	call sub_6030h		;6b61	cd 30 60 	. 0 ` 
	cp 02ch		;6b64	fe 2c 	. , 
	jr z,l6b6dh		;6b66	28 05 	( . 
	call sub_4f54h		;6b68	cd 54 4f 	. T O 
...
sub_6b8ah:
	push af			;6b8a	f5 	. 
	call sub_6030h		;6b8b	cd 30 60 	. 0 ` 
	inc ix		;6b8e	dd 23 	. # 
	cp 028h		;6b90	fe 28 	. ( 
	jr nz,l6baeh		;6b92	20 1a 	  . 
	call sub_4f97h		;6b94	cd 97 4f 	. . O 
	call sub_603eh		;6b97	cd 3e 60 	. > ` 
	pop af			;6b9a	f1 	. 
	push af			;6b9b	f5 	. 
...
l6baeh:
	...
	call sub_6042h		;6bb3	cd 42 60 	. B ` 
	call sub_4f97h		;6bb6	cd 97 4f 	. . O 
	call sub_603eh		;6bb9	cd 3e 60 	. > ` 
...
l6bd2h:
	...
	nop			;6be1	00 	. 
l6be2h:
	call sub_6046h		;6be2	cd 46 60 	. F ` 
	pop af			;6be5	f1 	. 
...
l780dh:
	push de			;780d	d5 	. 
	push bc			;780e	c5 	. 
	call l7a53h		;780f	cd 53 7a 	. S z 
	pop de			;7812	d1 	. 
	ld c,e			;7813	4b 	K 
	pop de			;7814	d1 	. 
	call l7732h		;7815	cd 32 77 	. 2 w 
	jp l79fah		;7818	c3 fa 79 	. . y 
sub_781bh:
	bit 7,h		;781b	cb 7c 	. | 
	push af			;781d	f5 	. 
	res 7,h		;781e	cb bc 	. . 
	call sub_782dh		;7820	cd 2d 78 	. - x 
	pop af			;7823	f1 	. 
	ret z			;7824	c8 	. 
...
sub_78e5h:
	...
	ld de,kernel_end		;78ef	11 00 80 	. . . 
...
l791ah:
	...
	ld de,kernel_end		;791d	11 00 80 	. . . 
...
l7923h:
	...
	ld hl,kernel_end		;792a	21 00 80 	! . . 
	ret			;792d	c9 	. 
l792eh:
...
l7990h:
	push hl			;7990	e5 	. 
	push bc			;7991	c5 	. 
	call l792eh		;7992	cd 2e 79 	. . y 
	ld a,b			;7995	78 	x 
	pop bc			;7996	c1 	. 
	ex (sp),hl			;7997	e3 	. 
	push af			;7998	f5 	. 
	call l7936h		;7999	cd 36 79 	. 6 y 
	pop af			;799c	f1 	. 
	ld c,a			;799d	4f 	O 
	pop de			;799e	d1 	. 
...
l7a53h:
	...
	sbc a,a			;7a87	9f 	. 
	ld h,a			;7a88	67 	g 
	call sub_782dh		;7a89	cd 2d 78 	. - x 
	pop af			;7a8c	f1 	. 
	ld c,a			;7a8d	4f 	O 
	pop de			;7a8e	d1 	. 
...
l7c7fh:
	...
	push de			;7c86	d5 	. 
	call sub_782dh		;7c87	cd 2d 78 	. - x 
	pop de			;7c8a	d1 	. 
sub_7c8bh:
	ld a,(de)			;7c8b	1a 	. 
	cp 020h		;7c8c	fe 20 	.   
...
l7f72h:
	...
	ld e,c			;7f9e	59 	Y 
	ld d,b			;7f9f	50 	P 
	ld hl,kernel_end		;7fa0	21 00 80 	! . . 
	ldir		;7fa3	ed b0 	. . 
